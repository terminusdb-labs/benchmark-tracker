...
function commentFooter() {
    ...
    return `This comment was automatically generated by [workflow](${actionUrl}) using [\`terminusdb-labs/benchmark-tracker\`](https://github.com/terminusdb-labs/benchmark-tracker).`;
}
