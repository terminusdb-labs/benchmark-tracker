...
function commentFooter(): string {
    ...
    return `This comment was automatically generated by [workflow](${actionUrl}) using [\`terminusdb-labs/benchmark-action\`](https://github.com/terminusdb-labs/benchmark-action).`;
}
