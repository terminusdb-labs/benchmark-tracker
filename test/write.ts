        ...
        const normalCases: Array<{
            ...
            },
            {
                ...
                error: [
                    ...
                    '',
                    'This comment was automatically generated by [workflow](https://github.com/user/repo/actions?query=workflow%3AWorkflow%20name) using [`terminusdb-labs/benchmark-action`](https://github.com/terminusdb-labs/benchmark-action).',
                    '',
                    'CC: @user',
                ],
            },
        ...
        for (const t of normalCases) {
            it(t.it, async function () {
                ...
                if (t.commitComment !== undefined) {
                    ...
                    eq(actionLink.text(), 'terminusdb-labs/benchmark-action');
                    eq(actionLink.attr('href'), 'https://github.com/terminusdb-labs/benchmark-action');
                }
            });
        }
    });
